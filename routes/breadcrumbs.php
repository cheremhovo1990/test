...
Breadcrumbs::register('adverts.inner_region', function (Crumbs $crumbs, \App\Http\Router\AdvertsPath $path) {
...
Breadcrumbs::register('adverts.inner_category', function (Crumbs $crumbs, \App\Http\Router\AdvertsPath $path, \App\Http\Router\AdvertsPath $orig) {
...
Breadcrumbs::register('adverts.index', function (Crumbs $crumbs, \App\Http\Router\AdvertsPath $path = null) {
