        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input id="content" class="form-control{{$errors->has('content') ? ' is-invalid' : ''}}"
                ...
                @foreach($category->allAttributes() as $attribute)
                    <div class="form-group">
                        ...
                        @if ($attribute->isSelect())
                            <select id="attribute_{{$attribute->id}}" name="attribute[{{$attribute->id}}]"
                        ...
                        @if ($errors->has('attribute.' . $attribute->id))
                            <span
                                class="invalid-feedback"><strong>{{$errors->first('attribute.' . $attribute->id)}}</strong></span>
                        @endif
                    </div>
                @endforeach
            </div>
