            ...
            <div class="card-body pb-2">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="title" class="form-control{{$errors->has('title') ? ' is-invalid' : ''}}"
                                   type="text" name="title" value="{{old('title', $advert->title)}}" required>
                            @if ($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <input id="address" type="number"
                           class="form-control{{$errors->has('address') ? ' is-invalid' : ''}}" name="price"
                ...
                <div class="form-group">
                    ...
                    <input id="content" type="number"
                           class="form-control{{$errors->has('content') ? ' is-invalid' : ''}}" name="price"
                           value="{{old('content', $advert->content)}}" required>
