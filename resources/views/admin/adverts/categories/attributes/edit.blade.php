    ...
    <form method="post" action="{{route('admin.adverts.categories.attributes.update',[$category, $attribute])}}">
        ...
        <div class="form-group">
            ...
            <input id="name" class="form-control{{$errors->has('name') ? ' is-invalid': ''}}" name="name"
                   value="{{old('name', $attribute->name)}}" type="text" required>
            @if($errors->has('name'))
        ...
        <div class="form-group">
            ...
            <input id="sort" class="form-control{{$errors->has('sort') ? ' is-invalid': ''}}" name="sort"
                   value="{{old('sort', $attribute->sort)}}" type="text" required>
            @if($errors->has('sort'))
        ...
        <div class="form-group">
            ...
            <textarea name="variants" type="text" class="form-control{{$errors->has('sort') ? ' is-invalid': ''}}"
                      id="variants">{{old('variants', implode("\n", $attribute->variants))}}</textarea>
