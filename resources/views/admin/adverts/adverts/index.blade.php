                ...
                <div class="row">
                    <div class="col-sm-1">
                        <div class="form-group">
                            ...
                            <input id="id" class="form-control" name="id" value="{{request('id')}}" type="text">
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label for="name" class="col-form-label">Title</label>
                            <input id="name" class="form-control" name="name" value="{{request('name')}}" type="text">
                        </div>
                    </div>
                    <div class="col-sm-1">
                        <div class="form-group">
                            <label for="user" class="col-form-label">User</label>
                            <input id="user" class="form-control" name="user" value="{{request('user')}}" type="text">
                        </div>
                    </div>
                    <div class="col-sm-1">
                        <div class="form-group">
    ...
    <table class="table table-striped">
        ...
        @foreach($adverts as $advert)
            <tr>
                ...
                <td><a href="{{route('adverts.show')}}" target="_blank">{{$advert->title}}</a></td>
                ...
                <td>{{$advert->categery->id}} - {{$advert->category->name}}</td>
                <td>
                    @if ($advert->isDraft())
